...
class AlignableButton: UIButton {
    ...
    func topAlignedImageRect(forContentRect contentRect: CGRect) -> CGRect {
        ...
        let xPosition = (contentRect.width - rect.width) / 2.0 + contentRect.minX
        let yPosition = contentRect.minY
    ...
    func bottomAlignedImageRect(forContentRect contentRect: CGRect) -> CGRect {
        ...
        let xPosition = (contentRect.width - rect.width) / 2.0 + contentRect.minX
        let yPosition = contentRect.height - rect.height + contentRect.minY
        let width = rect.width
        let height = rect.height
    ...
    func leftAlignedImageRect(forContentRect contentRect: CGRect) -> CGRect {
        ...
        let xPosition = contentRect.minX
        let yPosition = (contentRect.height - rect.height) / 2 + contentRect.minY
        let width = rect.width
        let height = rect.height
    ...
    func rightAlignedImageRect(forContentRect contentRect: CGRect) -> CGRect {
        ...
        let xPosition = (contentRect.width - rect.width) + contentRect.minX
        let yPosition = (contentRect.height - rect.height) / 2 + contentRect.minY
        let width = rect.width
        let height = rect.height
    ...
    func leftAlignedTitleRect(forContentRect contentRect: CGRect) -> CGRect {
        ...
        let xPosition = imageRect.width + imageRect.minX
        let yPosition = (contentRect.height - titleRect.height) / 2.0 + contentRect.minY
        let width = contentRect.width - imageRect.width * 2.0
    ...
    func rightAlignedTitleRect(forContentRect contentRect: CGRect) -> CGRect {
        ...
        let xPosition = contentRect.minX + imageRect.width
        let yPosition = (contentRect.height - titleRect.height) / 2.0 + contentRect.minY
        let width = contentRect.width - imageRect.width * 2.0
        let height = titleRect.height
