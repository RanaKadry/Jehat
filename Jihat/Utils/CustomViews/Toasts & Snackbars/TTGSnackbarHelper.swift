...
class TTGSnackbarHelper {
    ...
    class func showSnackBar(
        withBackgroundColor backgroundColor: UIColor = DesignSystem.Colors.primary.color,
        ...
        withDuration duration: TTGSnackbarDuration = .long,
        ...
        if snackbar == nil {
            ...
            if let actionText = actionText {
                ...
                snackbar = TTGSnackbar.init(message: message, duration: duration)
                snackbar?.messageTextFont = DesignSystem.Typography.paragraphSmall.font
            }
