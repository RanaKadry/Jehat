...
//        tintColor = color
    ...
    func updateView() {
        ...
        if let image = leadingImage {
            ...
            imageView.addGestureRecognizer(UITapGestureRecognizer(target: self, action: #selector(imageViewDidPressed(_:))))
    ...
    @objc
    private func imageViewDidPressed(_ sender: UITapGestureRecognizer) {
        imageClick?()
    }
}
