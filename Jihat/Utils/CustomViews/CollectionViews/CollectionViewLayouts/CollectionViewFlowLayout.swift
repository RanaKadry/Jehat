...
class CollectionViewFlowLayout: UICollectionViewFlowLayout {
    ...
    override func layoutAttributesForElements(in rect: CGRect) -> [UICollectionViewLayoutAttributes]? {
        ...
        if cellAttributesArray != nil && cellAttributesArray!.count > 1 {
            for iIndex in 1..<(cellAttributesArray!.count) {
                let prevLayoutAttributes: UICollectionViewLayoutAttributes = cellAttributesArray![iIndex - 1]
                let currentLayoutAttributes: UICollectionViewLayoutAttributes = cellAttributesArray![iIndex]
