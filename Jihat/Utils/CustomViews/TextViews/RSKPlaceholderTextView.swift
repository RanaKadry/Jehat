...
@IBDesignable open class RSKPlaceholderTextView: UITextView {
    ...
    @IBInspectable open var placeholder: NSString? {
        ...
        get {
            ...
            return self.attributedPlaceholder?.string.localized() as NSString?
        }
        set {
            
            if let newValue = newValue as String? {
                
                self.attributedPlaceholder = NSAttributedString(string: newValue.localized(), attributes: self.placeholderAttributes)
            }
            else {
